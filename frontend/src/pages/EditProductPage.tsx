...
//handleDragEnter y handleDragLeave son diseñadas para trabajar con eventos de arrastrar y soltar (drag-and-drop) en una etiqueta HTML. Lo usamos para agarrar una imagen y arrastrarla hasta donde la queremos colocar
